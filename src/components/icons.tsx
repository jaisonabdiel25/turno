// Íconos SVG inline (estilo Lucide, stroke 2, 24x24) para no depender de emojis
// ni de una librería externa. Heredan el color con `currentColor` y el tamaño
// con la clase que se les pase (p. ej. `className="h-5 w-5"`).
